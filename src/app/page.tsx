        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                href="/tickets"
                className="hidden sm:inline-flex items-center gap-2 px-4 py-2 rounded-lg font-bold text-sm text-white transition-all pc-glow-btn"
              >
          ...
          {mobileMenuOpen && (
            <div className="lg:hidden border-t pb-4">
              <nav className="flex flex-col gap-1 pt-2">
                ...
                <a
                  href="/tickets"
                  className="flex items-center justify-center gap-2 py-2 px-4 rounded font-bold mt-2 text-white pc-glow-btn"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z" />
                  </svg>
